<script lang="ts">
    ...
    let eventList = $state([
        ...
        {id: '2', hour: 10, day: 'Mar', title: 'Reunión de equipo', details: 'Discusión de proyectos'},
        {id: '3', hour: 14, day: 'Mié', title: 'Presentación cliente', details: 'Propuesta comercial'},
